c = (if window.location.href.match(/c=inline/i) then "inline" else "popup")
$.fn.editable.defaults.mode = (if c is "inline" then "inline" else "popup")  
...
$ ->
  ...
  $(".editable-form #meeting_start").editable
    ...
    validate: (v) ->
      "Day cant be 10!"  if v and v.getDate() is 10
  ...
  $(".editable-form #address").editable
    ...
    validate: (value) ->
      "city is required!"  if value.city is ""
